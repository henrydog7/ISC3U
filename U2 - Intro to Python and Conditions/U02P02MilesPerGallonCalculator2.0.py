...
##
## File Name: U02P02MilesPerGallonCalculator2.0.py
## Other Files: none
##
## Program Description
##
...
## liters               remembers the amount of liters input by the user
...
#output
    ...
    print ("Kilometers:".rjust(15), end =" ")
    print ('{0:10.2f}'.format(kilometers))
    print ("Liters:".rjust(15), end =" ")
    print ('{0:10.2f}'.format(liters))
    print ("Miles:".rjust(15), end =" ")
    print ('{0:10.2f}'.format(miles))
    print ("Gallons:".rjust(15), end =" ")
    print ('{0:10.2f}'.format(gallons))
    print ("Miles / Gallon:".rjust(15), end =" ")
    print ('{0:10.2f}'.format(miles_per_gallon))
